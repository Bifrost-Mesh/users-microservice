...
func (c *usersServiceClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/apis.users.UsersService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersServiceClient) Signup(ctx context.Context, in *SignupRequest, opts ...grpc.CallOption) (*SigninResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/apis.users.UsersService/Signup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersServiceClient) Signin(ctx context.Context, in *SigninRequest, opts ...grpc.CallOption) (*SigninResponse, error) {
	out := new(SigninResponse)
	err := c.cc.Invoke(ctx, "/apis.users.UsersService/Signin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UsersService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apis.users.UsersService/Ping",
	}
...
func _UsersService_Signup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apis.users.UsersService/Signup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UsersService_Signin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apis.users.UsersService/Signin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var UsersService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "apis.users.UsersService",
	...
	Metadata: "proto/users-api.proto",
}
